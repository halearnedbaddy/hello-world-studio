      ...
      <div className="bg-card rounded-2xl w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 pb-4 border-b border-border">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-foreground">🚀 Upgrade to Add More Products</h2>
              <p className="text-sm text-muted-foreground mt-1">
                You've reached your limit on the Free Starter plan. Choose a plan to continue growing.
              </p>
            </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="text-lg font-bold text-foreground uppercase">{plan.name} Plan</h3>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    Pay KES {price.toLocaleString()}/{billingCycle === 'monthly' ? 'month' : 'year'} →
                  </button>
                  <button
